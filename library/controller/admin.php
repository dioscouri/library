...
class DSCControllerAdmin extends DSCController
{
    ...
    function getNamespace()
    {
        ...
        $ns = $app->getName().'::'.'com.sample.model.'.$model->getTable()->get('_suffix');
        return $ns;
    }
    ...
    function release()
    {
        ...
        $redirect = "index.php?option=com_sample&controller=".$this->get('suffix')."&view=".$this->get('suffix')."&task=view&id=".$model->getId()."&donotcheckout=1";
    ...
    function cancel()
    {
        if (!isset($this->redirect)) {
            $this->redirect = 'index.php?option=com_sample&view='.$this->get('suffix');
        }
    ...
    function delete()
    {
        ...
        if (!isset($this->redirect)) {
            ...
            : 'index.php?option=com_sample&view='.$this->get('suffix');
    ...
    function order()
    {
        ...
        $this->messagetype  = '';
        $this->message      = '';
        $redirect = 'index.php?option=com_sample&view='.$this->get('suffix');
        $redirect = JRoute::_( $redirect, false );
    ...
    function pagetooltip_switch()
    {
        ...
        $msg->link      = 'index.php?option=com_sample&view='.$view;
        ...
        JTable::addIncludePath( JPATH_ADMINISTRATOR.DS.'components'.DS.'com_sample'.DS.'tables'.DS );
        unset($table);
    ...
    function footer()
    {
        Sample::load( "SampleModelDashboard", "models.dashboard" );
        $model  = new SampleModelDashboard();
    ...
    function doTaskAjax()
    {
        JLoader::import( 'com_sample.library.json', JPATH_ADMINISTRATOR.DS.'components' );
